/**
 * @file      CameraWebServer_SoftAP.ino
...
// ===========================
const char *soft_ap_ssid = "LilyGo-Cam";
...
void setup()
{
    ...
    Serial.print("Soft AP Name:"); Serial.println(soft_ap_ssid);
    Serial.print("Soft AP Password:"); Serial.println(soft_ap_password);
