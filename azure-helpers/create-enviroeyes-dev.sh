...
az webapp config appsettings set --name $AZURE_APP_NAME --resource-group $AZURE_RESOURCE_GROUP --settings SendgridFromAddress="$EnviroeyesDev_SendgridFromAddress" --output none
