...
#pragma warning disable CS8602
    ...
    public class ProjectCreateModel : PageModel
    {
        private readonly ILogger<ProjectCreateModel> _logger;
        private AppDbContext _appDbContext;
        private StorageHelper _storageHelper;

        public List<Project> projects {get;}

        public ProjectCreateModel(ILogger<ProjectCreateModel> logger, AppDbContext appDbContext, IConfiguration configuration)
        {
            _logger = logger;
