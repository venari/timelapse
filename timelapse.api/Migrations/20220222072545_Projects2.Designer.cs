...
namespace timelapse.api.Migrations
{
    ...
    [Migration("20220222072545_Projects2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("timelapse.core.models.DevicePlacement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_device_placement");

                    b.HasIndex("DeviceId")
                        .HasDatabaseName("ix_device_placement_device_id");

                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_device_placement_project_id");

                    b.ToTable("device_placement", (string)null);
                });
            ...
            modelBuilder.Entity("timelapse.core.models.ProjectUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_project_user_project_id");
            ...
            modelBuilder.Entity("timelapse.core.models.DevicePlacement", b =>
                {
                    b.HasOne("timelapse.core.models.Device", "Device")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_device_placement_devices_device_id");
                    ...
                    b.HasOne("timelapse.core.models.Project", "Project")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_device_placement_projects_project_id");
            ...
            modelBuilder.Entity("timelapse.core.models.ProjectUser", b =>
                {
                    b.HasOne("timelapse.core.models.Project", "Project")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_user_projects_project_id");
