...
namespace timelapse.api.Migrations
{
    ...
    [Migration("20260613122719_timelapseStatusAndUrlNullable")]
    partial class timelapseStatusAndUrlNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("timelapse.core.models.Event", b =>
                {
                    ...
                    b.Property<DateTime?>("TimelapseCreatedDate")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("timelapse_created_date");

                    b.Property<string>("TimelapseStatus")
                        .HasColumnType("text")
                        .HasColumnName("timelapse_status");

                    b.Property<string>("TimelapseUrl")
                        .HasColumnType("text")
                        .HasColumnName("timelapse_url");
            ...
            modelBuilder.Entity("timelapse.core.models.Image", b =>
                {
                    ...
                    b.HasIndex("Timestamp")
                        .HasDatabaseName("ix_images_timestamp");
            ...
            modelBuilder.Entity("EventEventType", b =>
                {
                    b.HasOne("timelapse.core.models.EventType", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_event_event_type_event_type_event_types_id");
                    ...
                    b.HasOne("timelapse.core.models.Event", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_event_event_type_event_events_id");
                });
            ...
            modelBuilder.Entity("timelapse.core.models.DeviceLocation", b =>
                {
                    b.HasOne("timelapse.core.models.Device", "Device")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_device_location_device_device_id");
            ...
            modelBuilder.Entity("timelapse.core.models.EventComment", b =>
                {
                    b.HasOne("timelapse.core.models.Event", "Event")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_event_comment_event_event_id");
            ...
            modelBuilder.Entity("timelapse.core.models.OrganisationUserJoinEntry", b =>
                {
                    b.HasOne("timelapse.core.models.Organisation", "Organisation")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_organisation_user_join_entry_organisation_organisation_id");
            ...
            modelBuilder.Entity("timelapse.core.models.Project", b =>
                {
                    b.HasOne("timelapse.core.models.Organisation", "Organisation")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_projects_organisation_organisation_id");
            ...
            modelBuilder.Entity("timelapse.core.models.Telemetry", b =>
                {
                    b.HasOne("timelapse.core.models.Device", "Device")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_telemetry_device_device_id");
