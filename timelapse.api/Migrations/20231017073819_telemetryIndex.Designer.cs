...
namespace timelapse.api.Migrations
{
    ...
    [Migration("20231017073819_telemetryIndex")]
    partial class telemetryIndex
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("timelapse.core.models.Container", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("OwnerOrganisationId")
                        .HasDatabaseName("ix_containers_owner_organisation_id");
            ...
            modelBuilder.Entity("timelapse.core.models.Event", b =>
                {
                    ...
                    b.Property<int>("EndImageId")
                        .HasColumnType("integer")
                        .HasColumnName("end_image_id");
                    ...
                    b.Property<int>("StartImageId")
                        .HasColumnType("integer")
                        .HasColumnName("start_image_id");
            ...
            modelBuilder.Entity("timelapse.core.models.EventType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("timelapse.core.models.Project", b =>
                {
                    ...
                    b.Property<int?>("ContainerOverideId")
                        .HasColumnType("integer")
                        .HasColumnName("container_overide_id");
                    ...
                    b.HasIndex("ContainerOverideId")
                        .HasDatabaseName("ix_projects_container_overide_id");
            ...
            modelBuilder.Entity("timelapse.core.models.Container_AWS_S3", b =>
                {
                    b.HasBaseType("timelapse.core.models.Container");
                    ...
                    b.HasDiscriminator().HasValue("Container_AWS_S3");
                });

            modelBuilder.Entity("timelapse.core.models.Container_Azure_Blob", b =>
                {
                    b.HasBaseType("timelapse.core.models.Container");
                    ...
                    b.HasDiscriminator().HasValue("Container_Azure_Blob");
                });
            ...
            modelBuilder.Entity("timelapse.core.models.Container", b =>
                {
                    b.HasOne("timelapse.core.models.Organisation", "OwnerOrganisation")
                        .WithMany("Containers")
                        .HasForeignKey("OwnerOrganisationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_containers_organisations_owner_organisation_id");
            ...
            modelBuilder.Entity("timelapse.core.models.Event", b =>
                {
                    ...
                    b.HasOne("timelapse.core.models.Image", "EndImage")
                        .WithMany()
                        .HasForeignKey("EndImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("timelapse.core.models.Image", "StartImage")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_events_images_start_image_id");
            ...
            modelBuilder.Entity("timelapse.core.models.Project", b =>
                {
                    b.HasOne("timelapse.core.models.Container", "ContainerOveride")
                        .WithMany()
                        .HasForeignKey("ContainerOverideId")
                        .HasConstraintName("fk_projects_containers_container_overide_id");
